...
/**
 * Segment-control style list — matches the Warehouse/Catalog switcher
 * used throughout the app (bg-slate-100/80 pill container).
 *
 * By default renders as w-fit (wraps content).
 * Pass className="w-full" to stretch full width.
 */
